<template>
  <div class="container">
    <!--nav class="navbar navbar-expand-lg navbar-light bg-light ">
      <div class="collapse navbar-collapse">
        <ul class="navbar-nav">
          ...
          <router-link tag="li" class="nav-item" to="/login" active-class="active">
    ...
    <v-app>
      <v-app-bar color="deep-purple accent-2" dense dark max-height="50px"
        app
      >
        ...
        <v-spacer></v-spacer>
        <v-btn to = "/login" primary
        color="deep-purple accent-2">
           LOGIN2
        </v-btn>
        
        <v-btn to = "/sheduler" primary
        color="deep-purple accent-2"
        mb-15
        >
           Sheduler
